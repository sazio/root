function U = rot_plan_form(X, T)
% rotation the plan for analysis
...
[x1_proj_matrix, y1_proj_matrix] = hom2int(x_rot, y_rot);
z1_proj_matrix = z_rot;
U = [x1_proj_matrix, y1_proj_matrix];
